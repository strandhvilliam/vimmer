...
import { makeNewZipDto } from "./utils"

class InvalidArgumentsError extends Data.TaggedError("InvalidArgumentsError")<{
  cause?: unknown
}> {}

class DataNotFoundError extends Data.TaggedError("DataNotFoundError")<{
  domain: string
  reference: string
  key?: string
  message?: string
...
class FailedToGenerateZipError extends Data.TaggedError(
...
class ZipWorker extends Effect.Service<ZipWorker>()(
