...
export class FileValidationsService extends Effect.Service<FileValidationsService>()(
  "@vimmer/packages/validation/file-validations-service",
  {
            ...
            return yield* Effect.fail(
              new ValidationFailure({
                ...
                context: {
                  ...
                  allowedMimeTypes: filteredMimeTypes.map(
                    ([_, value]) => value
                  ),
                },
              })
