...
export const competitionClassesRouter = createTRPCRouter({
  getById: publicProcedure
    ...
    .query(async ({ ctx, input }) => {
      return await getCompetitionClassByIdQuery(ctx.db, {
        id: input.id,
      })
    }),
  ...
  create: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return await createCompetitionClass(ctx.db, {
        data: input.data,
      })
    }),
  update: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return await updateCompetitionClass(ctx.db, {
        id: input.id,
        data: input.data,
      })
    }),
  delete: publicProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      return await deleteCompetitionClass(ctx.db, {
        id: input.id,
      })
    }),
})
